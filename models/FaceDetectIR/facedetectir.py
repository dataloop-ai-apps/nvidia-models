...
class FaceDetectIR:
    def __init__(self):
        ...
        if not os.path.isfile("/tmp/tao_models/facedetectir_vunpruned_v1.0/resnet18_facedetectir.tlt"):
    ...
    def detect(self, images_dir):
        ...
        try:
            ...
            with os.popen(
                    ...
                    f'-e {os.getcwd()}/models/FaceDetectIR/inference_spec.txt '
                    f'-i {images_dir} '
